...
\begin{table}[ht]
	...
	\label{tbl:padc}}{
		...
		\begin{tabular}{|l|p{14cm}|}
			...
			\hline
			Firebug		& Extenção para o Firefox que é utilizada para inúmeras atividades de depuração e estatística do navegador. \\
			\hline
		\end{tabular}
		}
\end{table}
