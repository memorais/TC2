...
Um \ingles{case} de utilização do novo formato, é o da própria \ingles{Google}, que substituiu as imagens, de formato PNGs e JPEGs para WebP, em sua \ingles{Web Store} do navegador Chrome, diminuindo a utilização de banda dirária, de acordo com Stephen Konig (Google Product Manager):
\begin{citacao}
...
O trabalho desenvolvido foi entegue à comunidade do Firefox, mas sua aplicação oficial na árvore da Mozilla não foi o foco principal. O objetivo deste trabalho não visa a aceitação por parte da equipe do Mozilla, em integrar a implementação desenvolvida ao código fonte do repositório oficial do Firefox, mas sim em contribuir com o desenvolvimento da renderização nativa do formato WebP dentro do navegador.
...
\begin{table}[ht]
	...
	\label{tbl:padc}}{
		...
		\begin{tabular}{|l|l|l|l|l|l|}
	    	\hline
			\textbf{2013} & \textbf{Internet Explorer} & \textbf{Firefox} &\textbf{Chrome} & \textbf{Safari} & \textbf{Opera} \\
			\hline
			...
			\hline
			December	& 16.4\% & 32.2\% & 44.1\% & 4.2\% & 2.1\% \\
			\hline
