...
\begin{figure}[h]
  \centering
    \includegraphics[scale=0.55]{ComponentesArquitetura.png}
...
\begin{algorithmic}
	...
	\FOR{Para cada linha a linha do \ingles{buffer}}
...
O site completo em sua formação original possui tamanho total de 12452K, e após a conversão das imagens para WebP, o tamanho total passou a ser de 2107K. A figura 5.7 apresenta a página inicial do segundo \ingles{site} criado para teste.
