...
Este trabalho está estruturado em seis capítulos. O primeiro capítulo apresenta uma contextualização sobre o assunto, bem como a motivação e os objetivos. Já no capítulo 2, a fundamentação teórica está exposta apresentando as tecnologias que possuem ligação direta com a implementação desenvolvida. O capítulo 3 apresenta uma descrição mais aprofundada sobre os principais conceitos e tecnologias que fazem parte do escopo do desenvolvimento.
No capítulo 4, é apresentado os trabalhos relacionados, que possuem objetivos semelhantes ao assunto tratado e que de alguma forma contribuíram para a analise e estudo. 
No capítulo 5 está a descrição da implementação proposta, cotendo a descrição dos módulos que foram desenvolvidos e os resultados que foram obtidos a partir dos testes executados. No capítulo 7 são feitas as conclusões e considerações finais deste trabalho, bem como planos de desenvolvimento para trabalhos futuros. O documento encerra contendo as referências bibliográficas que foram utilizadas como base para estudo e pesquisa ao longo do desenvolvimento deste trabalho.
