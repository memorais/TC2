...
A versão 0.3 da libwebp oferece suporte à animação de imagens quadro a quadro, semelhante ao processo realizado pelo formato GIF. Entretanto este tipo de implementação não foi realizada no desenvolvimento do codificador e do decodificador dentro deste trabalho, ficando como referência para trabalhos futuros que podem ser realizados.
